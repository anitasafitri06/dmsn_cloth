...
<body>
	<div class="container text-center">
		<div class="logo-404">
			<a href="index.html"><img src="<?php echo base_url()?>assets/front/images/home/dmsn.jpg" alt="" /></a>
		</div>
		<div class="content-404">
			<img src="<?php echo base_url()?>assets/front/images/404/404.png" class="img-responsive" alt="" />
			<h1><b>OPPS!</b>Tidak Ditemukan Halaman Tersebut</h1>
			<p>Uh... Terjadi kesalahan. Halaman yang kamu lihat bermasalah</p>
			<h2><a href="<?php echo base_url();?>">Kembali ke Home</a></h2>
		</div>
	</div>
