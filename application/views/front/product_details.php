		...
		<div id="similar-product" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="item active">
					<a href=""><img src="<?php echo base_url()?>assets/front/images/product-details/13.jpg" style="width: 70px" alt=""></a>
					<a href=""><img src="<?php echo base_url()?>assets/front/images/product-details/bajubaru.jpg" style="width: 80px" alt=""></a>
					<a href=""><img src="<?php echo base_url()?>assets/front/images/product-details/topi3.jpg" style="width: 80px" alt=""></a>
				</div>
				<div class="item">
					<a href=""><img src="<?php echo base_url()?>assets/front/images/product-details/13.jpg" style="width: 70px" alt=""></a>
					<a href=""><img src="<?php echo base_url()?>assets/front/images/product-details/bajubaru.jpg" style="width: 80px" alt=""></a>
